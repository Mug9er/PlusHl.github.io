...
>  关于为什么要选择这个代价函数，我偶然看见一个UP做过一个视频，[视频在这](["损失函数"是如何设计出来的？直观理解"最小二乘法"和"极大似然估计法"_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1Y64y1Q7hi?spm_id_from=333.851.b_7265636f6d6d656e64.9))我简单说一下我的理解
>
