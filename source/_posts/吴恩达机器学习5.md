...
$\Theta^{(1)}\in\R^{10\times11},\Theta^{(2)}\in\R^{(10\times11)},\Theta^{(3)}\in\R^{(1\times11)}$

$D^{(1)}\in\R^{10\times11},D^{(2)}\in\R^{(10\times11)},D^{(3)}\in\R^{(1\times11)}$
...
> $Theta = ranf(10,11)*(2*INIT\_EPSILON) - INIT\_EPSILON$
